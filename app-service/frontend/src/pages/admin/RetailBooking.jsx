...
const RetailBooking = () => {
    ...
    useEffect(() => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post('http://127.0.0.1:5000/admin/insert_record', formData, {
            withCredentials: true
          });
    ...
    return (
        <section className='margin'>
            <form onSubmit={handleSubmit} className="max-w-6xl p-4 bg-slate-100 shadow-md rounded-lg">
                ...
                <div className="flex  flex-wrap justify-normal items-center gap-4 p-3 mt-2">
                    ...
                    <div className='space-x-2 flex items-center'>
                        ...
                        <select name="Ptnr_Code" id="Ptnr_Code" className="border text-gray-500 border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-lime-600">
                    ...
                    <div className='space-x-2 flex items-center'>
                        ...
                        <input type="text" name="Ptnr_CN" id="Ptnr_CN" className="border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-lime-600" />
                    </div>
                </div>
                <h1 className="font-bold text-2xl text-black relative max-sm:text-center mt-5">
                ...
                <div className="flex  flex-wrap justify-normal items-center gap-4 p-2 mt-5">
                    ...
                    <div className='space-x-2 flex items-center  max-sm:mx-auto '>
                        ...
                        <select name="Product" id="Product" className="border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-lime-600">
                    ...
                    <div className='space-x-2 flex items-center'>
                        ...
                        <select name="Service" id="Service" className="border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-lime-600">
                    ...
                    <div className='space-x-2 flex items-center'>
                        ...
                        <input type="text" name="AcctNo" id="AcctNo" className="border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-lime-600" />
                    </div>
                    {/* Pickup Date default value of today */}
                    <div className='space-x-2 flex items-center'>
                        <label htmlFor="Pku_Date" className="text-black font-medium">Pickup Date</label>
                        <input type="date" name="Pku_Date" id="Pku_Date" className="border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-lime-600" />
                    </div>
                    {/* Booking Date default value of today */}
                    <div className='space-x-2 flex items-center'>
                        <label htmlFor="Bkg_Date" className="text-black font-medium">Booking Date</label>
                        <input type="Date" name="Bkg_Date" id="Bkg_Date" className="border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-lime-600" />
                    </div>
                </div>
